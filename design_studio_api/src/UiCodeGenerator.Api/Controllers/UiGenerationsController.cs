...
public sealed class UiGenerationsController(IUiGenerationService uiGenerationService) : ControllerBase
{
    ...
    public ActionResult<object> GetExample() => Ok(new
    {
        request = CreateExampleRequest(),
        response = CreateExampleResponse()
    });

    private static GenerateUiRequest CreateExampleRequest() => new()
    {
    ...
    private static GenerateUiResponse CreateExampleResponse() => new(
        ...
        new GeneratedSourceCode
        {
            ...
            [
                ...
                {
                    Path = "LoginScreen.html",
                    Content = "<main>Sign in</main>"
                }
            ]
        },
